...
(function () {
  ...
  function setTheme(theme) {
    ...
    if (toggleBtn) {
      ...
      toggleBtn.setAttribute(
        "aria-label",
        `Switch to ${THEMES[(THEMES.indexOf(theme) + 1) % 3]} mode`,
      );
    }
  }
  ...
  function setAccessible(enabled) {
    ...
    document.dispatchEvent(
      new CustomEvent("accessibilityChanged", { detail: { enabled } }),
    );
  }
